...
public class BrandManager implements BrandService {
	...
	public Result delete(int id) {
		...
		checkIfThisBrandIsUsedInAnotherTable(id);
	...
	private void checkIfThisBrandIsUsedInAnotherTable(int id) {

		if (!this.carService.getByBrand_BrandId(id).getData().isEmpty()) {
			throw new BusinessException(BusinessMessages.BRANDISUSEDINCARTABLE);
		}
	}
